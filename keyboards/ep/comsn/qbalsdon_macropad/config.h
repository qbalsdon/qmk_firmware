...
#define PRODUCT      qbalsdon_macropad
 ...
 *
 */
#define MATRIX_ROW_PINS { F0, F1, D2, D4, C6, D7, E6 }
#define MATRIX_COL_PINS { D3, B4, B5, B7, D5 }
#define UNUSED_PINS
...
#define OLED_TIMEOUT 5000 //not working
